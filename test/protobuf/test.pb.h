...
inline ::test::User* GetFriendListsResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:test.GetFriendListsResponse.friend_list)
...
GetFriendListsResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:test.GetFriendListsResponse.friend_list)
  return &_impl_.friend_list_;
}
inline const ::test::User& GetFriendListsResponse::_internal_friend_list(int index) const {
  return _impl_.friend_list_.Get(index);
}
inline const ::test::User& GetFriendListsResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:test.GetFriendListsResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::test::User* GetFriendListsResponse::_internal_add_friend_list() {
  return _impl_.friend_list_.Add();
}
inline ::test::User* GetFriendListsResponse::add_friend_list() {
  ::test::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:test.GetFriendListsResponse.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::test::User >&
GetFriendListsResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:test.GetFriendListsResponse.friend_list)
  return _impl_.friend_list_;
}
